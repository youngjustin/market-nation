...
public class JMSListener {
    ...
    @Autowired
    private OutputNumberRepository outputNumberRepository;
    ...
    // see https://docs.spring.io/spring-framework/docs/current/javadoc-api/org/springframework/jms/annotation/JmsListener.html
